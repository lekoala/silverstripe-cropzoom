...
class CropZoomController extends Controller {
	...
	/**
	 * This action need to crop the file
	 * 
	 * Available post vars are
	 * 
	 * viewPortW
	 * viewPortH
	 * imageX
	...
	function doCropZoom() {
		...
		$imageSource = $request->postVar('imageSource');
		$fileSource = Director::baseFolder() . $imageSource;
...
//		rename($fileSource, $fileSource . '.original');
		$this->parseImage($ext, $selector, $fileSource);
